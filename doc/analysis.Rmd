...
The figure above shows that most duplications happen in multiplicity 2 and 3 (which were not included in the first version of this analysis). Here is an example of three sites that have identical intensities across all samples:
...
To avoid probles with differential abundance I remove duplicates, leaving the first one out of each group.
